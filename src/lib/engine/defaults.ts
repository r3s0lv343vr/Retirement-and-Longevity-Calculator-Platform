...
> = {
  ...
  lifestyleSpendToday: { label: "Lifestyle spending / year", hint: "Today’s dollars. Housing, food, travel — not medical. Rises with general inflation.", group: "spending", kind: "money" },
  healthcareSpendToday: { label: "Healthcare spending / year", hint: "Today’s dollars. Premiums + out-of-pocket. Rises faster than CPI and with age.", group: "spending", kind: "money" },
  longTermCareAnnual: { label: "Long-term care / year", hint: "Optional in-home or extra support from the start age. Skipped once nursing or CCRC rent starts.", group: "spending", kind: "money" },
  longTermCareStartAge: { label: "Long-term care starts", hint: "First year this extra care cost is charged.", group: "spending", kind: "age" },
